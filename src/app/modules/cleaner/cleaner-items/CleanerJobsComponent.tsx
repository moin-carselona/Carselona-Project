...
const CleanerJobsComponent = () => {
  ...
  const handleSupervisorChange = (e: any) => {
    axios
      .get(
        `${API}?start=${0}&length=${pageLength}&attendencedatefrom=${attendencedatefrom}&attendencedateto=${attendencedateto}&cleanerselectedId=${
          e.target.value
        }`
      )
      .then((response) => {
  ...
  const handleCleanerChange = (e: any) => {
    axios
      .get(
        `${API}?start=${0}&length=${pageLength}&attendencedatefrom=${attendencedatefrom}&attendencedateto=${attendencedateto}&supervisorId=${
          e.target.value
        }`
      )
      .then((response) => {
