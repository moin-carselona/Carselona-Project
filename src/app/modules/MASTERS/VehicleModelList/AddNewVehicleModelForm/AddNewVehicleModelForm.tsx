...
const AddNewVehicleModelForm = ({ PopUpVehicleModelBTN }: Props) => {
    ...
    const handleVahicleModelCreateFormBTN = async () => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handleVahicleModelCreateFormBTN}>Add Society</span>
                </button>
            </div>
        </div>
    )
}
export default AddNewVehicleModelForm
