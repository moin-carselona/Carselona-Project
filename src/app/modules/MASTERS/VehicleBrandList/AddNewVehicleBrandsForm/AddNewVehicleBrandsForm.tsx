...
const AddNewVehicleBrandsForm = ({ PopUpVehcileBrandBTN }: Props) => {
    ...
    const handleVehicleBrandCreate = async () => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handleVehicleBrandCreate}>Add Society</span>
                </button>
            </div>
        </div>
    )
}
export default AddNewVehicleBrandsForm
