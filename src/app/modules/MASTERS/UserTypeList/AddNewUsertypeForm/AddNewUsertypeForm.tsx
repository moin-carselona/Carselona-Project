...
const AddNewUsertypeForm = ({ PopUpUserTypeBTN }: Props) => {
    ...
    const handleCreateUserTypes = async () => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handleCreateUserTypes}>Add Society</span>
                </button>
            </div>
        </div>
    )
}
export default AddNewUsertypeForm
