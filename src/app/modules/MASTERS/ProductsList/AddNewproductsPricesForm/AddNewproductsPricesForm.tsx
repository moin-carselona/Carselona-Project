...
let IDS: any = "";
const AddNewproductsPricesForm = ({ PopUpProductsListsBTN }: Props) => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handleCreateNewProducts}>Add New Products</span>
                </button>
            </div>
        </div>
    )
}
export default AddNewproductsPricesForm
