...
const AddNewTrainingtopicsForm = ({ PopUpTrainingtopicsBTN }: Props) => {
    ...
    const handleCreatetrainingtopics = async () => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handleCreatetrainingtopics}>Add Society</span>
                </button>
            </div>
        </div>
    )
}
export default AddNewTrainingtopicsForm
