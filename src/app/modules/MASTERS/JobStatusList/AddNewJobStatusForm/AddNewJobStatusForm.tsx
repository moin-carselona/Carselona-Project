...
const AddNewJobStatusForm = ({ PopUpJobStatusBTN }: Props) => {
    ...
    const handleCreateJobListData = async () => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handleCreateJobListData}>Add Society</span>
                </button>
            </div>
        </div>
    )
}
export default AddNewJobStatusForm
