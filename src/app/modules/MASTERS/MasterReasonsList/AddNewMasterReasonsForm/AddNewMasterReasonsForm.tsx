...
const AddNewMasterReasonsForm = ({ PopUpMasterReasonsBTN }: Props) => {
    ...
    const handleCreateMasterReasons = async () => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handleCreateMasterReasons}>Add Society</span>
                </button>
            </div>
        </div>
    )
}
export default AddNewMasterReasonsForm
