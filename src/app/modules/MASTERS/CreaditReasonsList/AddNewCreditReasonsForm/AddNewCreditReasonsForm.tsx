...
const AddNewCreditReasonsForm = ({ PopUpCreditReasonBTN }: Props) => {
    ...
    const hnadleCreditReasonCreate = async () => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={hnadleCreditReasonCreate}>Add Society</span>
                </button>
            </div>
        </div>
    )
}
export default AddNewCreditReasonsForm
