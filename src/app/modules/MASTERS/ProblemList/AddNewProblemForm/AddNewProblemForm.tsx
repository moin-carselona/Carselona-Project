...
const AddNewProblemForm = ({ PopUpProblemBTN }: Props) => {
    ...
    const handleCreateNewProblems = async () => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handleCreateNewProblems}>Add Society</span>
                </button>
            </div>
        </div>
    )
